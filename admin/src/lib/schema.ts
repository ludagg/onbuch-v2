...
export const RESOURCES: Resource[] = [
  {
    ...
    fields: [
      ...
      { key: 'price', label: 'Prix normal (FCFA)', type: 'number', help: '0 = « Prix sur demande ».' },
      { key: 'promoPrice', label: 'Prix promo (FCFA)', type: 'number', help: 'Prix réduit. Doit être < prix normal. 0 = pas de promo. La réduction est affichée automatiquement.' },
