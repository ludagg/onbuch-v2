...
\imgph{ch01-spectre-aimant-droit}{Spectre magnétique d’un aimant droit obtenu avec de la limaille de fer : lignes allant du pôle nord au pôle sud.}
...
\imgph{ch01-spectre-aimant-u}{Spectre magnétique d’un aimant en U : lignes quasi parallèles entre les pôles (champ uniforme).}
