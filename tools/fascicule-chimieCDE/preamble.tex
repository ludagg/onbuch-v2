...
\usepackage[version=4]{mhchem}   % réactions : \ce{...}
\usepackage{chemfig}             % formules développées/topologiques organiques
\usepackage{graphicx}
...
\fancyfoot[C]{\small\textsf{\color{onbmuted}Chimie · Terminales C·D·E·TI · Baccalauréat}}
...
% Règle (alias type loi, titre « Règle ») + illustration (cadre figure avec titre optionnel)
\newtcolorbox{regle}[1][]{colback=white,colframe=onbgreen,boxrule=0pt,
  leftrule=3pt,arc=3pt,left=12pt,right=12pt,top=8pt,bottom=8pt,breakable,
  title={\sffamily\bfseries Règle},coltitle=onbgreen,colbacktitle=white,
  fonttitle=\sffamily\bfseries,attach title to upper={\;\;\textmd{\itshape#1}\par\smallskip}}
\newtcolorbox{illustration}[1][]{colback=white,colframe=onbline,boxrule=0.8pt,arc=4pt,
  left=8pt,right=8pt,top=8pt,bottom=6pt,halign=center,breakable,
  before upper={\ifstrempty{#1}{}{{\footnotesize\itshape\color{onbmuted}#1\par\smallskip}}}}
...
% Oxydant / réducteur génériques (oxydoréduction)
