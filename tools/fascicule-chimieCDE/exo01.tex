...
contenant que C, H et O fournit \SI{0.66}{\gram} de $\ce{CO2}$ et \SI{0.27}{\gram}
...
et oxygène. La combustion complète de \SI{0.45}{\gram} de $A$ produit
\SI{0.88}{\gram} de dioxyde de carbone et \SI{0.45}{\gram} d'eau. Par ailleurs, la
vaporisation de \SI{0.45}{\gram} de $A$ occupe un volume de \SI{0.20}{\litre} dans
...
\SI{0.45}{\gram} de $A$, puis établir sa formule brute.
...
Sa combustion complète donne un volume de dioxyde de carbone égal à trois fois le
volume de $X$ brûlé (mesurés dans les mêmes conditions).
\begin{enumerate}[label=\arabic*)]
\item Déterminer la masse molaire de $X$.
\item Montrer que la molécule de $X$ contient 3 atomes de carbone.
